...
//     console.log(ele);
//    var data = fetch("https://api.openweathermap.org/data/2.5/weather?q=ele&appid=fa2fc8ee8fa3b9d189f1d15326523568");
...
//     .then(function(data){
//         alert(JSON.stringify(data.country));
//     })
...
// window.addEventListener("click",getLatLong());